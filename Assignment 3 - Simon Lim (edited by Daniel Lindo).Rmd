...
I believe that this project could benefit from a visualisation in which not only the general composition of Anseriformes is examined but the species themselves are highlighted showing the possible differences in diversity (ie. species composition) between Canada and Argentina. I believe that a stacked bar chart is the best option for this because it is a simple graphic that can include multiple different points.
